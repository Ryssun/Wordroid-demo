...
public class Test extends Activity {
	...
	Button nextBtn, overBtn, attention,helpBtn;
...
//		Typeface tf = Typeface.createFromAsset(getAssets(), "fonts/SEGOEUI.TTF");
		Typeface tf = Typeface.createFromAsset(getAssets(), "fonts/ARIALI.TTF");
		...
		meaning0.setTypeface(tf,Typeface.ITALIC);
		meaning1.setTypeface(tf,Typeface.ITALIC);
		meaning2.setTypeface(tf,Typeface.ITALIC);
		meaning3.setTypeface(tf,Typeface.ITALIC);
