 ...
 *
 */
public class ShowAttentionWord extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		this.setTitle("查看生词详情");
		this.setContentView(R.layout.attentionword);
	...
	private void initWidgets() {
		// TODO Auto-generated method stub
		this.spelling = (TextView) this.findViewById(R.id.EditWord_spelling);
		this.confirm = (Button) this.findViewById(R.id.attention_confirm_button);
		this.meanning = (TextView) this.findViewById(R.id.EditWord_meanning);
	...
	public void onClick(View v) {
		...
		if (v==confirm){
			if (meanning.getText().toString().equals("")||spelling.getText().toString().equals("")){
				Toast.makeText(ShowAttentionWord.this, "信息不能为空", Toast.LENGTH_SHORT).show();
				return;
			}
			...
			for(int i=0;i<words.size();i++){
				...
				DataAccess data = new DataAccess(ShowAttentionWord.this);
			    Word word = data.QueryAttention("ID = '"+bundle.getString("id")+"'", null).get(0);
