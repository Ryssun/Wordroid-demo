...
public class ReviewMain extends TabActivity implements TabHost.TabContentFactory{
	...
	public void onCreate(Bundle savedInstanceState){
		...
		th.addTab(th.newTabSpec("shouldreview").setIndicator("复习表",ReviewMain.this.getResources().getDrawable(R.drawable.should)).setContent(this));
		th.addTab(th.newTabSpec("alllists").setIndicator("所有",ReviewMain.this.getResources().getDrawable(R.drawable.all)).setContent(this));
