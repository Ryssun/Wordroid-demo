...
public class study extends TabActivity implements TabHost.TabContentFactory{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        th.addTab(th.newTabSpec("studid").setIndicator("未完成",study.this.getResources().getDrawable(R.drawable.not_learn)).setContent(this));
        th.addTab(th.newTabSpec("all").setIndicator("所有",study.this.getResources().getDrawable(R.drawable.all)).setContent(this));
    }
